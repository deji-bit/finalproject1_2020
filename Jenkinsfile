pipeline {
   ...
   stages {
     stage('Polling SCM' ) {
	     ...
	     pwd
	    sudo scp -o StrictHostKeychecking=no -i /home/ec2-user/first-keys -rf /var/lib/jenkins/workspace/appdeploy01_main/finalproject1_2020/ ec2-user@172.31.5.213:/tmp
	    pwd
            '''
      	 }  
       }
